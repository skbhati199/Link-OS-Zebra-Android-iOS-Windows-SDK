...
public enum PrinterModelInfo {
    ...
    PrinterModelInfo(PrinterModel printerModel, String displayName, int maxWidth, int maxHeight) {
    ...
    public static PrinterModelInfo getFromDisplayName(String displayName) {
        if (displayName != null) {
            for (PrinterModelInfo printerModelInfo : PrinterModelInfo.values()) {
                if (displayName.equals(printerModelInfo.toString())) {
