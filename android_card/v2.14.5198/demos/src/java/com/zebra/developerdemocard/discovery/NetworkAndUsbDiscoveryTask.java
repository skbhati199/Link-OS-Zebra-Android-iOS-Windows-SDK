...
public class NetworkAndUsbDiscoveryTask extends AsyncTask<Void, Void, Void> {
    ...
    private static final List<Integer> INVALID_PRODUCT_ID_LIST = Arrays.asList(0050, 80);
        ...
        try {
            UsbDiscoverer.findPrinters(usbManager, new DiscoveryHandler() {
                ...
                public void foundPrinter(DiscoveredPrinter discoveredPrinter) {
                    if (!INVALID_PRODUCT_ID_LIST.contains(((DiscoveredPrinterUsb) discoveredPrinter).device.getProductId())) {
                        if (onPrinterDiscoveryListener != null) {
