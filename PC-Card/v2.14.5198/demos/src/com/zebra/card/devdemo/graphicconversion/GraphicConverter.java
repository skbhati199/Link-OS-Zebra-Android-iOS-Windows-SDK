...
public class GraphicConverter {
	...
	public GraphicConverter(GraphicsContainer graphicsContainer, JTextArea outputArea) {
		...
		this.inputFilePath = graphicsContainer.getInputFilePath();
		this.outputFilePath = graphicsContainer.getOutputFilePath();
		this.printerModelInfo = graphicsContainer.getPrinterModelInfo();
		this.format = graphicsContainer.getFormat();
		this.widthString = graphicsContainer.getWidth();
		this.heightString = graphicsContainer.getHeight();
		this.dimensionOption = graphicsContainer.getDimensionOption();
		this.xoffsetString = graphicsContainer.getXOffset();
		this.yoffsetString = graphicsContainer.getYOffset();
	}
